...
<html lang="id">
  <head>
    ...
    <meta
      name="description"
      content="Perusahaan yang bergerak bidang pembangunan dan penjualan cluster perumahan"
    />
  ...
  <body>
    <section class="section-headersatu">
      <nav
        class="navbar navbar-expand-lg navbar-dark main-nav"
      ...
      >
        ...
        <div
          class="collapse navbar-collapse nav navbar-nav mx-auto"
          id="navbarText"
        >
        ...
        <a class="btn btn-primary" href="update-admin.php?konten=navbar" role="button">Edit</a>
      </nav>
      <center>
        ...
        <a class="btn btn-primary" href="update-admin.php?konten=konten-1" role="button">Edit</a>
      </center>
      <br />
    </section>
    ...
    <section class="section-headerdua">
      ...
      <center>
        ...
        <a class="btn btn-primary" href="update-admin.php?konten=konten-2" role="button">Edit</a>
      </center>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-lg text-center bg2-headertiga">
            <div class="section-boxWhite mx-auto content-headertiga2">
              ...
              <h3 class="font-weight-bold"><?php echo $text[$i++];?></h3>
              <h3 class="font-weight-bold"><?php echo $text[$i++];?></h3>
              <a class="btn btn-primary" href="update-admin.php?konten=konten-3" role="button">Edit</a>
            </div>
            <br />
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col content-4" >
            <img
              src="assets/image/cluster3.png"
              alt=""
              class="photo-3"
            />
            <img
              src="assets/image/cluster2.png"
              alt=""
              class="photo-2"
            />
          ...
          <div class="col-lg pt-4 text-center">
            ...
            <a class="btn btn-primary" href="update-admin.php?konten=konten-4" role="button">Edit</a>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-6 align-self-center pt-4 text-center">
            <div class="d-flex justify-content-end">
              <img
                ...
                alt=""
                class="img-fluid"
                style="box-shadow: 10px 10px 20px !important"
              />
            </div>
            <button type="button" class="btn btn-success my-5">
              <svg
            ...
            <a class="btn btn-primary" href="update-admin.php?konten=konten-5" role="button">Edit</a>
      ...
      <div class="container">
            ...
            <div style="position: relative">
              ...
              <div class="galeris">
                ...
                <label class="galeri" for="item-3" id="song-3">
                  <img
                    class="foto"
                    src="assets/image/carousel3.jpg"
                    alt="song"
                  />
                </label>
              </div>
        ...
        <div class="row justify-content-center mt-4">
          <div class="col-lg-3 col-md-3 mb-4">
            <iframe
              src="https://www.youtube.com/embed/bnBsBRRA93A"
              width="100%"
              height="150"
              frameborder="0"
              allowfullscreen
          ...
          <div class="col-lg-3 col-md-3 mb-4">
            <iframe
              src="https://www.youtube.com/embed/Z-Il0vxzTQk"
              width="100%"
              height="150"
              frameborder="0"
              allowfullscreen
          ...
          <div class="col-lg-3 col-md-3 mb-4">
            <iframe
              src="https://www.youtube.com/embed/reQhUwYMDQ4"
              width="100%"
              height="150"
              frameborder="0"
              allowfullscreen
          ...
          <div class="col-lg-3 col-md-3 mb-4">
            <iframe
              src="https://www.youtube.com/embed/7PeznlVg_o4"
              width="100%"
              height="150"
              frameborder="0"
              allowfullscreen
          ...
          <div class="col d-flex justify-content-center">
            ...
            <a class="btn btn-primary" href="update-admin.php?konten=konten-5a" role="button">Edit</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <!--Konten 3-->
    <section class="section-kontenDua">
      <div class="container">
        <div class="row d-flex justify-content-between">
          ...
          <div class="col-lg-5 section-boxWhite shadow-lg text-right">
            ...
            <div class="text-center">
              ...
              <a class="btn btn-primary" href="update-admin.php?konten=konten-6" role="button">Edit</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row d-flex justify-content-between">
          <div class="col-lg-6 pt-5 text-center">
            ...
            <a class="btn btn-primary" href="update-admin.php?konten=konten-7" role="button">Edit</a>
          </div>
    ...
    <div class="my-5 py-3" id="faqs">
      <div class="container">
        <div class="faq-1">
          ...
          <div class="d-flex justify-content-center align-items-center mt-5">
            ...
            <div class="kotak1"></div>
            <a class="btn btn-primary" href="update-admin.php?konten=konten-8" role="button">Edit</a>
          </div>
          <!-- TITLE END -->
      ...
      <div class="section-full mobile-page-padding my-5" id="harga">
        <div class="container">
          ...
          <a class="btn btn-primary" href="update-admin.php?konten=konten-8a" role="button">Edit</a>
        </div>
      </div>

      <div class="bg-form p-5">
        <div
          class="row mt-5 flex-column flex-md-row justify-content-around align-items-center"
        >
          <div class="col-md-4">
            <div
            ...
            >
              ...
              <a class="btn btn-primary" href="update-admin.php?konten=konten-8b" role="button">Edit</a>
            </div>
          </div>
          <div
            class="col-md-5 text-white p-10"
            style="background-image: linear-gradient(#ad8c32, #dcb64d)"
          >
            <h2 class="text-center font-weight-bold mt-2">Kontak Kami</h2>
            <form
              action="https://pesona.mbproperti.com/pakpos"
              id="posts"
            ...
            >
              <input
                type="hidden"
                name="csrf_token"
                value="e476c0a3633e3f6890cf1782f011832e"
              />
      ...
      <div class="row">
        <div class="col-md-8 mx-auto text-center my-5">
          ...
          <h3><?php echo $text[85];?></h3>
          <p class="font-weight-normal"><?php echo $text[86];?></p>
          <a class="btn btn-primary" href="update-admin.php?konten=siteplan" role="button">Edit</a>
        </div>
      </div>
    </div>
    ...
    <footer class="bg-dark text-white px-4">
      <div class="row flex justify-content-around">
        <div class="col-lg-5 col-md-12 col-sm-12 text-center">
          ...
          <div
            class="d-flex flex-row justify-content-around mx-2 align-items-lg-center"
          >
            <div class="item">
              <a class="border-0 justify-content-center align-items-center">
                <img
                  src="assets/bsi.svg"
                  alt="Projects MB Properti"
            ...
            <div class="item">
              <a class="border-0 justify-content-center align-items-center">
                <img
                  src="assets/btn-syariah.svg"
                  alt="Projects MB Properti"
                  style="height: 58px; width: 272px"
                  class="mx-auto d-block img-fluid"
                />
              </a>
            </div>
          </div>
          <a class="btn btn-primary" href="update-admin.php?konten=footer" role="button">Edit</a>
        </div>
        <!-- USEFUL LINKS -->
        <div class="col-lg-3 col-md-12 col-sm-12 pt-4">
          <div class="flex-column justify-content-start">
            ...
            <div class="row flex justify-content-around">
              <div class="">
                <a href="https://www.fb.com/ptmbproperti" target="_blank"
